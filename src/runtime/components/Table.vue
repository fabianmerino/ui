    ...
    <table ref="tableRef" :class="ui.base({ class: [props.ui?.base] })">
      ...
      <tbody :class="ui.tbody({ class: [props.ui?.tbody] })">
        ...
        <tr v-else-if="loading && !!slots['loading']">
          <td :colspan="tableApi.getAllFlatColumns().length" :class="ui.loading({ class: props.ui?.loading })">
            <slot name="loading" />
          </td>
        </tr>

        <tr v-else>
          <td :colspan="tableApi.getAllFlatColumns().length" :class="ui.empty({ class: props.ui?.empty })">
            <slot name="empty">
