...
1. **Replace Nuxt UI Pro with Nuxt UI:**
...
2. **Update your Nuxt configuration:**
...
If you're using Nuxt UI with Vue and Vite, you need to update your package and imports.
...
+ import { PageHero, PageSection } from '@nuxt/ui'
```
...
| v3 | v4 Replacement |
| --- | --- |
| `PageAccordion` | Use [`Accordion`](/docs/components/accordion) directly |
...
::tip{to="https://github.com/nuxt/ui/commit/9545fddec8ba88bbf523cdb26672129adc5ed4f3" target="_blank"}
See the full diff of the AI SDK v5 upgrade in the GitHub commit.
::
